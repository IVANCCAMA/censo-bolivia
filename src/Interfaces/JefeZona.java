...
public class JefeZona extends javax.swing.JFrame {
    ...
    private String getZonaCensal(){
        zona = "";
        try {
            String sql = "select ZonaCensal from censo.usuario where  codUsr = " ;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ver estado de zona censal");
        ...
        jLabel3.setText("Ver datos de encuestadores");
